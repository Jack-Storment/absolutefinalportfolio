            ...
            <Col lg="5">
              <ContactCard className="p-5 ml-lg-5">
                <div>
                  ...
                  <a href="mailto:stormentjd@gmail.com" className="font-weight-bold">
                    <Span color="primary">stormentjd@gmail.com</Span>
                  </a>
                </div>
                <div className="mt-5">
                  ...
                  <div>
                    <a href="tel:919-508-4830" className="font-weight-bold">
                      <Span color="primary">919-508-4830</Span>
                    </a>
                  </div>
                </div>
              </ContactCard>
